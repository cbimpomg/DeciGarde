...
function AnalogClock(_ref) {
  ...
  return /*#__PURE__*/React.createElement(View, _extends({
    ...
    style: [styles.clock, {
      backgroundColor: theme.dark ? Color(theme.colors.surface).lighten(1.4).hex() : theme.isV3 ? Color(theme.colors.outline).lighten(0.9).hex() : Color(theme.colors.surface).darken(0.1).hex()
