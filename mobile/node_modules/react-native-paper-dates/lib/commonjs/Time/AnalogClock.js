...
function AnalogClock(_ref) {
  ...
  return /*#__PURE__*/React.createElement(_reactNative.View, _extends({
    ...
    style: [styles.clock, {
      backgroundColor: theme.dark ? (0, _color.default)(theme.colors.surface).lighten(1.4).hex() : theme.isV3 ? (0, _color.default)(theme.colors.outline).lighten(0.9).hex() : (0, _color.default)(theme.colors.surface).darken(0.1).hex()
