...
function AmPmSwitcher(_ref) {
  ...
  const backgroundColor = (0, React.useMemo)(() => {
    ...
    return (0, _color.default)(theme.isV3 ? theme.colors.inverseOnSurface : theme.colors.surface).darken(0.1).hex();
  }, [theme]);
  const isAM = mode === 'AM';
...
function SwitchButton(_ref2) {
  ...
  let textFont = theme !== null && theme !== void 0 && theme.isV3 ? theme.fonts.bodyMedium : theme.fonts.medium;
